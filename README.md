...
- 🌙 **深色金融主題**：專業深藍色 UI，希臘字母欄位 Tooltip 說明；左側邊欄新增 V1.0 (V0) 與 V2.0 評價權證標準的條列說明欄位；排名大表單（Table）全新加裝實時自主精算之「價內外程度」欄位（置於 Delta 後方），並將「隱含波動」與「歷史波動性」全面升級為百分比格式呈現（如 58.58%），完美展現微小數據差距，供交易員隨時對照與檢索。
